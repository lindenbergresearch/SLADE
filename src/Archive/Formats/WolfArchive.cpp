...
size_t WolfConstant(int name, size_t numlumps) {
    ...
    switch (numlumps) {
        ...
        case 156:
            game = 2;
            break;    // It's the version I have but it's not in the Wolf source code...
        case 169:
            game = 6;
            break;    // GFXV_SOD
        case 414:
            game = 4;
            break;    // GFXE_WL6: Just a mess of chunks without anything usable
        case 556:
            game = 0;
            break;    // GFXV_WL1
        case 558:
    ...
    {
        case STARTPICS:
            return7(game, 3, 3, 3, 3, 0, 3, 3)
            break;
        case STARTPICM:
            return7(game, 139, 142, 147, 135, 0, 128, 150)
            break;
        case NUMTILE8:
            return7(game, 72, 72, 72, 72, 0, 72, 72)
            break;
        case STARTPAL:
            return7(game, 0, 0, 0, 0, 0, 131, 153)
            break;
        case ENDPAL:
            return7(game, 0, 0, 0, 0, 0, 131, 163)
            break;
        case TITLE1PIC:
            return7(game, 0, 0, 0, 0, 0, 74, 79)
            break;
        case TITLE2PIC:
            return7(game, 0, 0, 0, 0, 0, 75, 80)
            break;
        case ENDSCREEN1PIC:
            return7(game, 0, 0, 0, 0, 0, 0, 81)
            break;
        case ENDSCREEN9PIC:
            return7(game, 0, 0, 0, 0, 0, 0, 89)
            break;
        case IDGUYS1PIC:
            return7(game, 0, 0, 0, 0, 0, 0, 93)
            break;
        case IDGUYS2PIC:
            return7(game, 0, 0, 0, 0, 0, 0, 94)
            break;
    }
    return 0;
}
