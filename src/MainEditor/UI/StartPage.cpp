...
//
// ----------------------------------------------------------------------------
CVAR(Bool, web_dark_theme, true, CVAR_SAVE)
...
void SStartPage::init() {
    ...
    html_startpage_->Bind(
        wxEVT_WEBVIEW_ERROR, [&](wxWebViewEvent &e) {
    ...
    if (App::platform() == App::Platform::Windows) {
        html_startpage_->Bind(
            wxEVT_WEBVIEW_LOADED, [&](wxWebViewEvent &e) {
    ...
    Bind(
        wxEVT_THREAD_WEBGET_COMPLETED, [&](wxThreadEvent &e) {
