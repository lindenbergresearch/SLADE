...
void AudioEntryPanel::startStream() {
    ...
    switch (audio_type_) {
        ...
        case MIDI:
            ...
            break;
        case Media:
            if (media_ctrl_) media_ctrl_->Play();
            break;
        default:
            break;
    }
...
void AudioEntryPanel::stopStream() {
    switch (audio_type_) {
        ...
        case MIDI:
            ...
            break;
        case Media:
            if (media_ctrl_) media_ctrl_->Pause();
            break;
        default:
            break;
    }
...
void AudioEntryPanel::resetStream() {
    ...
    switch (audio_type_) {
        ...
        case MIDI:
            ...
            break;
        case Media:
            if (media_ctrl_) media_ctrl_->Stop();
            break;
        default:
            break;
    }
...
void AudioEntryPanel::onTimer(wxTimerEvent &e) {
    ...
    switch (audio_type_) {
        case Sound:
            pos = sound_->getPlayingOffset().asMilliseconds();
            break;
        case Music:
            pos = music_->getPlayingOffset().asMilliseconds();
            break;
        case Mod:
            pos = mod_->getPlayingOffset().asMilliseconds();
            break;
        case MIDI:
            pos = theMIDIPlayer->getPosition();
            break;
        case Media:
            if (media_ctrl_) pos = media_ctrl_->Tell();
            break;
        default:
            break;
    }
...
void AudioEntryPanel::onSliderSeekChanged(wxCommandEvent &e) {
    switch (audio_type_) {
        case Sound:
            sound_->setPlayingOffset(sf::milliseconds(slider_seek_->GetValue()));
            break;
        case Music:
            music_->setPlayingOffset(sf::milliseconds(slider_seek_->GetValue()));
            break;
        case Mod:
            mod_->setPlayingOffset(sf::milliseconds(slider_seek_->GetValue()));
            break;
        case MIDI:
            theMIDIPlayer->setPosition(slider_seek_->GetValue());
            break;
        case Media:
