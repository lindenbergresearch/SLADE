...
size_t replaceSpecialsHexen(
    ArchiveEntry *l_entry, ArchiveEntry *t_entry, int oldtype, int newtype,
...
size_t replaceSpecialsUDMF(
    ArchiveEntry *entry, int oldtype, int newtype,
    bool arg0, bool arg1, bool arg2, bool arg3, bool arg4,
    int oldarg0, int oldarg1, int oldarg2, int oldarg3, int oldarg4,
    int newarg0, int newarg1, int newarg2, int newarg3, int newarg4
) {
...
size_t ArchiveOperations::replaceSpecials(
    Archive *archive, int oldtype, int newtype, bool lines, bool things,
        ...
        if (maps[a].archive) {
            ...
            if (temp_archive->open(maps[a].head)) {
                achanged = ArchiveOperations::replaceSpecials(
                    temp_archive, oldtype, newtype, lines, things,
                ...
                switch (maps[a].format) {
                    ...
                    case MAP_HEXEN:
                        ...
                        achanged = replaceSpecialsHexen(
                            l_entry, t_entry, oldtype, newtype, arg0, arg1, arg2, arg3, arg4,
                    ...
                    case MAP_UDMF:
                        achanged = replaceSpecialsUDMF(
                            l_entry, oldtype, newtype, arg0, arg1, arg2, arg3, arg4,
                            oldarg0, oldarg1, oldarg2, oldarg3, oldarg4, newarg0, newarg1, newarg2, newarg3, newarg4
                        );
                        break;
                    default:
...
CONSOLE_COMMAND(replacespecials, 2, true) {
    ...
    if (current && run) {
        ArchiveOperations::replaceSpecials(
            current, oldtype, newtype, true, true,
