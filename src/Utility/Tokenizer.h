...
public:
    ...
    void setSpecialCharacters(const char *characters) { special_characters_.assign(characters, characters + strlen(characters)); }
    ...
    void getToken(string *str) {
        if (atEnd()) *str = ""; else *str = token_current_.text;
        adv();
    }
