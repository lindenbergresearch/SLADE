...
void UDMFProperty::parse(ParseTreeNode *node, string group) {
    ...
    for (unsigned a = 0; a < node->nChildren(); a++) {
        ...
        if (S_CMPNOCASE(prop->getName(), "type")) {
            ...
            switch (type_) {
                case Type::Boolean:
                    default_value_ = prop->boolValue();
                    break;
                case Type::Int:
                    default_value_ = prop->intValue();
                    break;
                case Type::Float:
                    default_value_ = prop->floatValue();
                    break;
                case Type::String:
                    default_value_ = prop->stringValue();
                    break;
                ...
                case Type::Angle:
                    default_value_ = prop->intValue();
                    break;
                case Type::TextureWall:
                    default_value_ = prop->stringValue();
                    break;
                case Type::TextureFlat:
                    default_value_ = prop->stringValue();
                    break;
                case Type::ID:
                    default_value_ = prop->intValue();
...
string UDMFProperty::getStringRep() {
    ...
    switch (type_) {
        ...
        case Type::Colour:
            ...
            break;
        case Type::ActionSpecial:
            ret += ", type = actionspecial";
            break;
        case Type::SectorSpecial:
            ret += ", type = sectorspecial";
            break;
        case Type::ThingType:
            ret += ", type = thingtype";
            break;
        case Type::Angle:
            ...
            break;
        case Type::TextureWall:
            ret += ", type = wall texture";
            break;
        case Type::TextureFlat:
            ret += ", type = flat texture";
            break;
        case Type::ID:
            ret += ", type = id";
            break;
