...
string parseLineType(int type) {
    ...
    if (type >= 0x6000) {
        ...
        switch (kind) {
            case 0:
                type_string += S_FMT("Open Wait %s Close", Delays[delay]);
                break;
            case 1:
                type_string += "Open Stay";
                break;
            case 2:
                type_string += S_FMT("Close Wait %s Open", Delays[delay]);
                break;
            case 3:
                type_string += "Close Stay";
                break;
            default:
                break;
        }
        ...
        switch (kind) {
            case 0:
                type_string += "Open Wait 4 Close";
                break;
            case 1:
                type_string += "Open Stay";
                break;
            case 2:
                type_string += "Close Wait 4 Open";
                break;
            case 3:
                type_string += "Close Stay";
                break;
