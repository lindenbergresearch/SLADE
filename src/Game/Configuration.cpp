...
bool Configuration::readConfiguration(string &cfg, string source, uint8_t format, bool ignore_game, bool clear) {
    ...
    switch (format) {
        case MAP_DOOM:
            parser.define("MAP_DOOM");
            break;
        case MAP_HEXEN:
            parser.define("MAP_HEXEN");
            break;
        case MAP_DOOM64:
            parser.define("MAP_DOOM64");
            break;
        case MAP_UDMF:
            parser.define("MAP_UDMF");
            break;
        default:
            parser.define("MAP_UNKNOWN");
            break;
    }
...
string Configuration::getDefaultString(int type, string property) {
    switch (type) {
        case MOBJ_LINE:
            return defaults_line_[property].getStringValue();
            break;
        case MOBJ_SIDE:
            return defaults_side_[property].getStringValue();
            break;
        case MOBJ_SECTOR:
            return defaults_sector_[property].getStringValue();
            break;
        case MOBJ_THING:
            return defaults_thing_[property].getStringValue();
            break;
        default:
            return "";
    }
...
int Configuration::getDefaultInt(int type, string property) {
    switch (type) {
        case MOBJ_LINE:
            return defaults_line_[property].getIntValue();
            break;
        case MOBJ_SIDE:
            return defaults_side_[property].getIntValue();
            break;
        case MOBJ_SECTOR:
            return defaults_sector_[property].getIntValue();
            break;
        case MOBJ_THING:
            return defaults_thing_[property].getIntValue();
            break;
        default:
            return 0;
    }
...
double Configuration::getDefaultFloat(int type, string property) {
    switch (type) {
        case MOBJ_LINE:
            return defaults_line_[property].getFloatValue();
            break;
        case MOBJ_SIDE:
            return defaults_side_[property].getFloatValue();
            break;
        case MOBJ_SECTOR:
            return defaults_sector_[property].getFloatValue();
            break;
        case MOBJ_THING:
            return defaults_thing_[property].getFloatValue();
            break;
        default:
            return 0;
    }
...
bool Configuration::getDefaultBool(int type, string property) {
    switch (type) {
        case MOBJ_LINE:
            return defaults_line_[property].getBoolValue();
            break;
        case MOBJ_SIDE:
            return defaults_side_[property].getBoolValue();
            break;
        case MOBJ_SECTOR:
            return defaults_sector_[property].getBoolValue();
            break;
        case MOBJ_THING:
            return defaults_thing_[property].getBoolValue();
            break;
        default:
            return false;
    }
