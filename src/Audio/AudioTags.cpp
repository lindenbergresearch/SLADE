...
string Audio::getSunInfo(MemChunk &mc) {
    ...
    switch (codec) {
        case 1:
            format += wxString::FromUTF8("\xCE\xBC-Law");
            break;
        case 2:
        case 3:
        case 4:
        case 5:
            format += S_FMT("PCM (signed)");
            break;
        case 6:
        case 7:
            format += S_FMT("PCM (float)");
            break;
        case 27:
            format += S_FMT("a-Law");
            break;
        default:
            format += S_FMT("Unknown (%u)", codec);
            break;
    }
    string ret = "Mono";
    if (channels == 2)
...
string Audio::getVocInfo(MemChunk &mc) {
    ...
    switch (codec) {
        case 0:
            format += S_FMT("PCM (unsigned)");
            break;
        case 1:
            format += S_FMT("4-to-8 ADPCM");
            break;
        case 2:
            format += S_FMT("3-to-8 ADPCM");
            break;
        case 3:
            format += S_FMT("2-to-8 ADPCM");
            break;
        case 4:
            format += S_FMT("PCM (signed)");
            break;
...
string Audio::getWavInfo(MemChunk &mc) {
    ...
    switch (formnum) {
        case 1:
            ...
            break;
        case 2:
            format += S_FMT("Microsoft ADPCM");
            break;
        case 3:
            format += S_FMT("IEEE754");
            break;
        case 6:
            format += S_FMT("ITU G.711 a-Law");
            break;
        case 7:
            format += wxString::FromUTF8("ITU G.711 \xCE\xBC-Law");
            break;
        case 17:
            format += S_FMT("IMA ADPCM");
            break;
        case 20:
            format += S_FMT("ITU G.723 ADPCM");
            break;
        case 49:
            format += S_FMT("GSM 6.10");
            break;
        case 64:
            format += S_FMT("ITU G.721 ADPCM");
            break;
        case 85:
            format += S_FMT("MPEG Layer 3");
            break;
        default:
            format += S_FMT("Unknown (%u)", fmt->tag);
            break;
    }
    string ret = "Mono";
