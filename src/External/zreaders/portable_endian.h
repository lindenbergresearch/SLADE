...
// Modified by roberto@zenvoid.org for Slade Doom Editor, all changes under the same license as the original.
...
#define LE_16I_TO_H(m) (int16_t)LE_16U_TO_H(m)
#define LE_32I_TO_H(m) (int32_t)LE_32U_TO_H(m)
