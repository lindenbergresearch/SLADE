...
static SRes BraState_Code(
    void *pp, Byte *dest, SizeT *destLen, const Byte *src, SizeT *srcLen,
...
SRes MixCoder_Code(
    CMixCoder *p, Byte *dest, SizeT *destLen,
...
SRes XzUnpacker_Code(
    CXzUnpacker *p, Byte *dest, SizeT *destLen,
