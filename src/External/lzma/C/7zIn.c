    ...
    for (;;) {
        ...
        switch ((int) type) {
            case k7zIdEnd:
                return SZ_OK;
            case k7zIdPackInfo: {
                RINOK(SzReadPackInfo(
                    sd, dataOffset, &p->NumPackStreams,
            ...
            case k7zIdSubStreamsInfo: {
                RINOK(SzReadSubStreamsInfo(
                    sd, p->NumFolders, p->Folders,
...
static SRes SzReadAndDecodePackedStreams(
    ...
    SRes res;
    SzAr_Init(&p);
    res = SzReadAndDecodePackedStreams2(
        inStream, sd, outBuffer, baseOffset,
